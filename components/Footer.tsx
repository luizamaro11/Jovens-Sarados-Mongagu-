        ...
        <footer className="bg-js-mystery text-white pt-20 pb-10">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-300">
                            ...
                            <li><a href="#join" className="hover:text-white transition-colors">Seja um voluntário</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-300">
                            <li>contato@jovenssarados.com</li>
                            <li>(11) 99999-9999</li>
                            <li>São Paulo, SP</li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
                    <p>&copy; 2024 Movimento Jovens Sarados. Todos os direitos reservados.</p>
